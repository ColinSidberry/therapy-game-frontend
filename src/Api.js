...
class FrienderApi {
  ...
  static async signup(formData) { //FIXME: 90% sure we don't need the multi-part form any more since we are not using AWS
    const result = await axios.post(`${BASE_API_URL}/signup`, formData, {
      headers: {
